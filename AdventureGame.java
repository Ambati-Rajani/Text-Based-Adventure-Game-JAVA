...
public class AdventureGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3. 'pick up <item>' - Pick up an item from the room and add it to your inventory(ex:potion,treasure).");
    ...
    static void combat(String command, Room room) {
        ...
        if (enemy != null) {
            if (command.equals("attack")) {
                ...
                move("south"); // Default to moving south as a retreat.
            }
        } else {
